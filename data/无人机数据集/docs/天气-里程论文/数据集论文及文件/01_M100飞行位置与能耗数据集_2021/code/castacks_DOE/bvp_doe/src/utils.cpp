#include "kite_bvp_solver/utils.h"
...
inline double SimpsonIntegration(Eigen::VectorXd fun_vals, Eigen::VectorXd weights, double ds) {
  return ds * fun_vals.dot(weights) / 3;
}

function [A, Aeq, grad_A, grad_Aeq] = nonlcon_with_grad(q, X0, Xf, v, vw_x, vw_y, params)
    % extract params
    ...
    err = terminal_error(q, num_poly_params, X0, Xf, v, vw_x, vw_y);
    A = [0.5 * err.^2; 0.5 * c1_f^2] - [params.bv_tol; params.curv1_tol];
    ...
    if nargout > 2
        ...
        grad_A = [...
            err(1) * get_grad_x(q, c1, c2, c3, psi1, psi2, psi3, sf1, sf2, sf3, v, vw_x, vw_y); ...
            err(2) * get_grad_y(q, c1, c2, c3, psi1, psi2, psi3, sf1, sf2, sf3, v, vw_x, vw_y); ...
            err(3) * get_grad_psi(q, c1, c2, c3, psi1, psi2, psi3, sf1, sf2, sf3, v, vw_x, vw_y); ...
            err(4) * get_grad_curv(q, c1, c2, c3, psi1, psi2, psi3, sf1, sf2, sf3, v, vw_x, vw_y); ...
            get_grad_curv_cost(q, c1, c2, c3, psi1, psi2, psi3, sf1, sf2, sf3, v, vw_x, vw_y) ...
        ]';

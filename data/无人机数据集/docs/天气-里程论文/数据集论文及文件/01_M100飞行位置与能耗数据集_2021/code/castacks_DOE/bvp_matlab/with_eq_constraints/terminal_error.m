function [err] = terminal_error(q, num_poly_params, X0, Xf, v, vw_x, vw_y)
    % extract params
    sf1 = q(end-2);
    sf2 = q(end-1);
    sf3 = q(end);
...
%     ];
    ...
    err = [...
        ...
        X0(2) + simpson_integration(fun_sinns1, 0, 501, 0, sf1) + ...
            ...
            vw_y * sf / v - Xf(2); ...
        wrapTo2Pi(polyval(psi3, sf3)) - Xf(3); ...
        ...%(polyval(psi3, sf3) - Xf(3)); ...
        ...%(get_corr_heading_change(wrapTo2Pi(polyval(psi3, sf3)), Xf(3)));
        polyval(c3, sf3) - Xf(4); ...
    ];
end
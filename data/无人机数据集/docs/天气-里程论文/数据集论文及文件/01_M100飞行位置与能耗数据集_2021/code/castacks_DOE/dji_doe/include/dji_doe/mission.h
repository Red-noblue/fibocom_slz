...
bool runWaypointMission(DJI::OSDK::float32_t speed, float32_t alt,  int responseTimeout);

void setWaypointDefaults(DJI::OSDK::WayPointSettings* wp);

void setWaypointInitDefaults(DJI::OSDK::float32_t speed, dji_sdk::MissionWaypointTask& waypointTask);

# 中文说明：本文件用于按高度变化趋势将单次飞行切分为起飞、巡航、降落三段，并兼容当前 pandas 版本。
'''
...
def normalize_altitude(df):
    """Normalize altitude so each flight starts from zero."""

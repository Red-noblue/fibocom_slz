...
def build_parser() -> argparse.ArgumentParser:
    ...
    sub_extract.add_argument("--is-ocr", action=argparse.BooleanOptionalAction, default=None, help="是否启用 OCR。")
    sub_extract.add_argument("--enable-formula", action=argparse.BooleanOptionalAction, default=None, help="是否启用公式识别。")
    sub_extract.add_argument("--enable-table", action=argparse.BooleanOptionalAction, default=None, help="是否启用表格识别。")
    ...
    sub_extract.add_argument("--no-cache", action=argparse.BooleanOptionalAction, default=None, help="URL 模式下是否跳过缓存。")
    ...
    sub_extract.add_argument(
        ...
        default=True,
        help="是否按输入文件名自动生成 `data_id`，默认开启。",
    )

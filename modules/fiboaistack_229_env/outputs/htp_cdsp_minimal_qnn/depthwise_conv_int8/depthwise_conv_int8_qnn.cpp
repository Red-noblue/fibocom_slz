...
static ModelError_t addTensor_input(QnnModel& model){
  ...
  uint32_t dimensions_input[] = {1, 8, 8, 4};
                           ...
                           (Qnn_Tensor_t) {
                               ...
                               {.v2= {
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_DEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0206989739090204f, .offset= -63}}},
                                 .rank= 4,
...
static ModelError_t addTensor_conv_weight(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_conv_weight[] = {3, 3, 1, 4};
  VALIDATE(model.addTensor("conv_weight", // Tensor Name
                           (Qnn_Tensor_t) {
                               ...
                               {.v2= {
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_DEFINED,
                                                    QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                                                    {.scaleOffsetEncoding= {.scale= 0.0002450980537105f, .offset= 0}}},
                                 .rank= 4,
...
static ModelError_t addTensor_conv_bias(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_conv_bias[] = {4};
  VALIDATE(model.addTensor("conv_bias", // Tensor Name
                           (Qnn_Tensor_t) {
                               ...
                               {.v2= {
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_DEFINED,
                                                    QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                                                    {.scaleOffsetEncoding= {.scale= 0.0004901961074211f, .offset= 0}}},
                                 .rank= 1,
...
static ModelError_t addNode__conv_Conv(QnnModel& model){
  ...
  uint32_t __conv_Conv_pad_amount[] = {1, 1, 1, 1};
  ...
  uint32_t dimensions_output[] = {1, 8, 8, 4};
  Qnn_Tensor_t outputs__conv_Conv[] = {
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_DEFINED,
                               QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                               {.scaleOffsetEncoding= {.scale= 0.0084721073508263f, .offset= -13}}},
            .rank= 4,
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for depthwise_conv_int8_qnn*/
  QnnModel depthwise_conv_int8_qnn;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("depthwise_conv_int8_qnn", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(depthwise_conv_int8_qnn.initialize(backendHandle, interface, contextHandle, "depthwise_conv_int8_qnn", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_input(depthwise_conv_int8_qnn), err);
  VALIDATE(addTensor_conv_weight(depthwise_conv_int8_qnn), err);
  VALIDATE(addTensor_conv_bias(depthwise_conv_int8_qnn), err);
  VALIDATE(addNode__conv_Conv(depthwise_conv_int8_qnn), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&depthwise_conv_int8_qnn};

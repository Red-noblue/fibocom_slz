...
static ModelError_t addTensor_weight_dq(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_weight_dq[] = {3, 3, 3, 5};
  VALIDATE(model.addTensor("weight_dq", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
                                 .rank= 4,
                                 .dimensions=dimensions_weight_dq,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(weight_dq),
                                                .dataSize=BINLEN(weight_dq)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addTensor_bias(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_bias[] = {5};
  VALIDATE(model.addTensor("bias", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
                                 .rank= 1,
                                 .dimensions=dimensions_bias,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(bias),
                                                .dataSize=BINLEN(bias)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode_qdq_conv(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR qdq_conv */
  uint32_t dimensions_qdq_conv_dilation[] = {2};
  uint32_t qdq_conv_dilation[] = {1, 1};
  uint32_t dimensions_qdq_conv_pad_amount[] = {2, 2};
  uint32_t qdq_conv_pad_amount[] = {1, 1, 1, 1};
  uint32_t dimensions_qdq_conv_stride[] = {2};
  uint32_t qdq_conv_stride[] = {1, 1};
  Qnn_Param_t params_qdq_conv[] = {
     ...
     {.tensorParam=(Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions_qdq_conv_dilation,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)qdq_conv_dilation,
                           .dataSize=8}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
     ...
     {.tensorParam=(Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions_qdq_conv_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)qdq_conv_pad_amount,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
     ...
     {.tensorParam=(Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions_qdq_conv_stride,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)qdq_conv_stride,
                           .dataSize=8}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs_qdq_conv[] = {
    "input",
    "weight_dq",
    "bias"
  };
  uint32_t dimensions_output[] = {1, 8, 8, 5};
  Qnn_Tensor_t outputs_qdq_conv[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         ...
                         params_qdq_conv, // Node Params
                         4, // Num Node Params
                         inputs_qdq_conv, // Input Tensor Names
                         3, // Num Input Tensor Names
                         outputs_qdq_conv, // Output Tensors 
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for qdq_int8_conv_qnn*/
  QnnModel qdq_int8_conv_qnn;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("qdq_int8_conv_qnn", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(qdq_int8_conv_qnn.initialize(backendHandle, interface, contextHandle, "qdq_int8_conv_qnn", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_input(qdq_int8_conv_qnn), err);
  VALIDATE(addTensor_weight_dq(qdq_int8_conv_qnn), err);
  VALIDATE(addTensor_bias(qdq_int8_conv_qnn), err);
  VALIDATE(addNode_qdq_conv(qdq_int8_conv_qnn), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&qdq_int8_conv_qnn};

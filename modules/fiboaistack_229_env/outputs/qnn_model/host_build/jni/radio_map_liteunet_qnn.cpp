...
static ModelError_t addNode__enc1_c1__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc1_c1__prepad_Pad */
  uint32_t dimensions___enc1_c1__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __enc1_c1__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__enc1_c1__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     ...
     {.tensorParam=(Qnn_Tensor_t) {
          ...
          {.v2= {
            .id=0,
            .name= "__enc1_c1__prepad_Pad_pad_amount",
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___enc1_c1__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__enc1_c1__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__enc1_c1__prepad_Pad[] = {
    "input"
  };
  uint32_t dimensions__enc1_c1__prepad_Pad_output_0[] = {1, 258, 258, 7};
  Qnn_Tensor_t outputs__enc1_c1__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc1_c1__prepad_Pad_output_0",
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc1_c1__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc1_c1__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__enc1_c1__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__enc1_c1__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc1_c1__prepad_Pad, // Output Tensors 
...
static ModelError_t addNode__enc1_c1_depth_Conv(QnnModel& model){
  ...
  uint32_t __enc1_c1_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__enc1_c1_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__enc1_c1_norm_Add_output_0[] = {1, 256, 256, 48};
  Qnn_Tensor_t outputs__enc1_c1_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc1_c1_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc1_c1_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__enc1_c1_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc1_c1_act_Relu */
  Qnn_Param_t params__enc1_c1_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__enc1_c1_act_Relu[] = {
    "_enc1_c1_norm_Add_output_0"
  };
  uint32_t dimensions__enc1_c1_act_Relu_output_0[] = {1, 256, 256, 48};
  Qnn_Tensor_t outputs__enc1_c1_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc1_c1_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__enc1_c1_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__enc1_c1_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc1_c1_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__enc1_c2__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc1_c2__prepad_Pad */
  uint32_t dimensions___enc1_c2__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __enc1_c2__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__enc1_c2__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__enc1_c2__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___enc1_c2__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__enc1_c2__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__enc1_c2__prepad_Pad[] = {
    "_enc1_c1_act_Relu_output_0"
  };
  uint32_t dimensions__enc1_c2__prepad_Pad_output_0[] = {1, 258, 258, 48};
  Qnn_Tensor_t outputs__enc1_c2__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc1_c2__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc1_c2__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc1_c2__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__enc1_c2__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__enc1_c2__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc1_c2__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__enc1_c2_depth_Conv(QnnModel& model){
  ...
  uint32_t __enc1_c2_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__enc1_c2_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__enc1_c2_norm_Add_output_0[] = {1, 256, 256, 48};
  Qnn_Tensor_t outputs__enc1_c2_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc1_c2_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc1_c2_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__enc1_c2_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc1_c2_act_Relu */
  Qnn_Param_t params__enc1_c2_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__enc1_c2_act_Relu[] = {
    "_enc1_c2_norm_Add_output_0"
  };
  uint32_t dimensions__enc1_c2_act_Relu_output_0[] = {1, 256, 256, 48};
  Qnn_Tensor_t outputs__enc1_c2_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc1_c2_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__enc1_c2_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__enc1_c2_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc1_c2_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__enc2_c1__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc2_c1__prepad_Pad */
  uint32_t dimensions___enc2_c1__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __enc2_c1__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__enc2_c1__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__enc2_c1__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___enc2_c1__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__enc2_c1__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__enc2_c1__prepad_Pad[] = {
    "_pool_AveragePool_output_0"
  };
  uint32_t dimensions__enc2_c1__prepad_Pad_output_0[] = {1, 130, 130, 48};
  Qnn_Tensor_t outputs__enc2_c1__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc2_c1__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc2_c1__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc2_c1__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__enc2_c1__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__enc2_c1__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc2_c1__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__enc2_c1_depth_Conv(QnnModel& model){
  ...
  uint32_t __enc2_c1_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__enc2_c1_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__enc2_c1_norm_Add_output_0[] = {1, 128, 128, 96};
  Qnn_Tensor_t outputs__enc2_c1_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc2_c1_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc2_c1_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__enc2_c1_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc2_c1_act_Relu */
  Qnn_Param_t params__enc2_c1_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__enc2_c1_act_Relu[] = {
    "_enc2_c1_norm_Add_output_0"
  };
  uint32_t dimensions__enc2_c1_act_Relu_output_0[] = {1, 128, 128, 96};
  Qnn_Tensor_t outputs__enc2_c1_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc2_c1_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__enc2_c1_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__enc2_c1_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc2_c1_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__enc2_c2__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc2_c2__prepad_Pad */
  uint32_t dimensions___enc2_c2__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __enc2_c2__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__enc2_c2__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__enc2_c2__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___enc2_c2__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__enc2_c2__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__enc2_c2__prepad_Pad[] = {
    "_enc2_c1_act_Relu_output_0"
  };
  uint32_t dimensions__enc2_c2__prepad_Pad_output_0[] = {1, 130, 130, 96};
  Qnn_Tensor_t outputs__enc2_c2__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc2_c2__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc2_c2__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc2_c2__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__enc2_c2__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__enc2_c2__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc2_c2__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__enc2_c2_depth_Conv(QnnModel& model){
  ...
  uint32_t __enc2_c2_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__enc2_c2_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__enc2_c2_norm_Add_output_0[] = {1, 128, 128, 96};
  Qnn_Tensor_t outputs__enc2_c2_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc2_c2_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc2_c2_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__enc2_c2_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc2_c2_act_Relu */
  Qnn_Param_t params__enc2_c2_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__enc2_c2_act_Relu[] = {
    "_enc2_c2_norm_Add_output_0"
  };
  uint32_t dimensions__enc2_c2_act_Relu_output_0[] = {1, 128, 128, 96};
  Qnn_Tensor_t outputs__enc2_c2_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc2_c2_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__enc2_c2_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__enc2_c2_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc2_c2_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__enc3_c1__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc3_c1__prepad_Pad */
  uint32_t dimensions___enc3_c1__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __enc3_c1__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__enc3_c1__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__enc3_c1__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___enc3_c1__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__enc3_c1__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__enc3_c1__prepad_Pad[] = {
    "_pool_1_AveragePool_output_0"
  };
  uint32_t dimensions__enc3_c1__prepad_Pad_output_0[] = {1, 66, 66, 96};
  Qnn_Tensor_t outputs__enc3_c1__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc3_c1__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc3_c1__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc3_c1__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__enc3_c1__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__enc3_c1__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc3_c1__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__enc3_c1_depth_Conv(QnnModel& model){
  ...
  uint32_t __enc3_c1_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__enc3_c1_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__enc3_c1_norm_Add_output_0[] = {1, 64, 64, 192};
  Qnn_Tensor_t outputs__enc3_c1_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc3_c1_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc3_c1_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__enc3_c1_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc3_c1_act_Relu */
  Qnn_Param_t params__enc3_c1_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__enc3_c1_act_Relu[] = {
    "_enc3_c1_norm_Add_output_0"
  };
  uint32_t dimensions__enc3_c1_act_Relu_output_0[] = {1, 64, 64, 192};
  Qnn_Tensor_t outputs__enc3_c1_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc3_c1_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__enc3_c1_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__enc3_c1_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc3_c1_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__enc3_c2__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc3_c2__prepad_Pad */
  uint32_t dimensions___enc3_c2__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __enc3_c2__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__enc3_c2__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__enc3_c2__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___enc3_c2__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__enc3_c2__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__enc3_c2__prepad_Pad[] = {
    "_enc3_c1_act_Relu_output_0"
  };
  uint32_t dimensions__enc3_c2__prepad_Pad_output_0[] = {1, 66, 66, 192};
  Qnn_Tensor_t outputs__enc3_c2__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc3_c2__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc3_c2__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc3_c2__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__enc3_c2__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__enc3_c2__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc3_c2__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__enc3_c2_depth_Conv(QnnModel& model){
  ...
  uint32_t __enc3_c2_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__enc3_c2_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__enc3_c2_norm_Add_output_0[] = {1, 64, 64, 192};
  Qnn_Tensor_t outputs__enc3_c2_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_enc3_c2_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__enc3_c2_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__enc3_c2_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _enc3_c2_act_Relu */
  Qnn_Param_t params__enc3_c2_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__enc3_c2_act_Relu[] = {
    "_enc3_c2_norm_Add_output_0"
  };
  uint32_t dimensions__enc3_c2_act_Relu_output_0[] = {1, 64, 64, 192};
  Qnn_Tensor_t outputs__enc3_c2_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_enc3_c2_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__enc3_c2_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__enc3_c2_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__enc3_c2_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__bottleneck_c1__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _bottleneck_c1__prepad_Pad */
  uint32_t dimensions___bottleneck_c1__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __bottleneck_c1__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__bottleneck_c1__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__bottleneck_c1__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___bottleneck_c1__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__bottleneck_c1__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__bottleneck_c1__prepad_Pad[] = {
    "_pool_2_AveragePool_output_0"
  };
  uint32_t dimensions__bottleneck_c1__prepad_Pad_output_0[] = {1, 34, 34, 192};
  Qnn_Tensor_t outputs__bottleneck_c1__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_bottleneck_c1__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__bottleneck_c1__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_bottleneck_c1__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__bottleneck_c1__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__bottleneck_c1__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__bottleneck_c1__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__bottleneck_c1_depth_Conv(QnnModel& model){
  ...
  uint32_t __bottleneck_c1_depth_Conv_pad_amount[] = {0, 0, 0, 0};
  ...
  const char*  inputs__bottleneck_c1_depth_Conv[] = {
    "_bottleneck_c1__prepad_Pad_output_0",
...
static ModelError_t addNode__bottleneck_c1_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__bottleneck_c1_norm_Add_output_0[] = {1, 32, 32, 384};
  Qnn_Tensor_t outputs__bottleneck_c1_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_bottleneck_c1_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__bottleneck_c1_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__bottleneck_c1_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _bottleneck_c1_act_Relu */
  Qnn_Param_t params__bottleneck_c1_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__bottleneck_c1_act_Relu[] = {
    "_bottleneck_c1_norm_Add_output_0"
  };
  uint32_t dimensions__bottleneck_c1_act_Relu_output_0[] = {1, 32, 32, 384};
  Qnn_Tensor_t outputs__bottleneck_c1_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_bottleneck_c1_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__bottleneck_c1_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__bottleneck_c1_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__bottleneck_c1_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__bottleneck_c2__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _bottleneck_c2__prepad_Pad */
  uint32_t dimensions___bottleneck_c2__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __bottleneck_c2__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__bottleneck_c2__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__bottleneck_c2__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___bottleneck_c2__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__bottleneck_c2__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__bottleneck_c2__prepad_Pad[] = {
    "_bottleneck_c1_act_Relu_output_0"
  };
  uint32_t dimensions__bottleneck_c2__prepad_Pad_output_0[] = {1, 34, 34, 384};
  Qnn_Tensor_t outputs__bottleneck_c2__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_bottleneck_c2__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__bottleneck_c2__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_bottleneck_c2__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__bottleneck_c2__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__bottleneck_c2__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__bottleneck_c2__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__bottleneck_c2_depth_Conv(QnnModel& model){
  ...
  uint32_t __bottleneck_c2_depth_Conv_pad_amount[] = {0, 0, 0, 0};
  ...
  const char*  inputs__bottleneck_c2_depth_Conv[] = {
    "_bottleneck_c2__prepad_Pad_output_0",
...
static ModelError_t addNode__bottleneck_c2_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__bottleneck_c2_norm_Add_output_0[] = {1, 32, 32, 384};
  Qnn_Tensor_t outputs__bottleneck_c2_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_bottleneck_c2_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__bottleneck_c2_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__bottleneck_c2_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _bottleneck_c2_act_Relu */
  Qnn_Param_t params__bottleneck_c2_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__bottleneck_c2_act_Relu[] = {
    "_bottleneck_c2_norm_Add_output_0"
  };
  uint32_t dimensions__bottleneck_c2_act_Relu_output_0[] = {1, 32, 32, 384};
  Qnn_Tensor_t outputs__bottleneck_c2_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_bottleneck_c2_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__bottleneck_c2_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__bottleneck_c2_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__bottleneck_c2_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__aspp_branches_0_branches_0_0_Conv(QnnModel& model){
  ...
  uint32_t dimensions__aspp_branches_0_branches_0_0_Conv_output_0[] = {1, 32, 32, 96};
  Qnn_Tensor_t outputs__aspp_branches_0_branches_0_0_Conv[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_aspp_branches_0_branches_0_0_Conv_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__aspp_branches_0_branches_0_0_Conv_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__aspp_branches_0_branches_0_2_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _aspp_branches_0_branches_0_2_Relu */
  Qnn_Param_t params__aspp_branches_0_branches_0_2_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__aspp_branches_0_branches_0_2_Relu[] = {
    "_aspp_branches_0_branches_0_0_Conv_output_0"
  };
  uint32_t dimensions__aspp_branches_0_branches_0_2_Relu_output_0[] = {1, 32, 32, 96};
  Qnn_Tensor_t outputs__aspp_branches_0_branches_0_2_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_aspp_branches_0_branches_0_2_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__aspp_branches_0_branches_0_2_Relu, // Node Params
                         1, // Num Node Params
                         inputs__aspp_branches_0_branches_0_2_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__aspp_branches_0_branches_0_2_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__aspp_branches_1_branches_1_0_Conv(QnnModel& model){
  ...
  uint32_t dimensions__aspp_branches_1_branches_1_0_Conv_output_0[] = {1, 32, 32, 96};
  Qnn_Tensor_t outputs__aspp_branches_1_branches_1_0_Conv[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_aspp_branches_1_branches_1_0_Conv_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__aspp_branches_1_branches_1_0_Conv_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__aspp_branches_1_branches_1_2_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _aspp_branches_1_branches_1_2_Relu */
  Qnn_Param_t params__aspp_branches_1_branches_1_2_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__aspp_branches_1_branches_1_2_Relu[] = {
    "_aspp_branches_1_branches_1_0_Conv_output_0"
  };
  uint32_t dimensions__aspp_branches_1_branches_1_2_Relu_output_0[] = {1, 32, 32, 96};
  Qnn_Tensor_t outputs__aspp_branches_1_branches_1_2_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_aspp_branches_1_branches_1_2_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__aspp_branches_1_branches_1_2_Relu, // Node Params
                         1, // Num Node Params
                         inputs__aspp_branches_1_branches_1_2_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__aspp_branches_1_branches_1_2_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__aspp_branches_2_branches_2_0_Conv(QnnModel& model){
  ...
  uint32_t dimensions__aspp_branches_2_branches_2_0_Conv_output_0[] = {1, 32, 32, 96};
  Qnn_Tensor_t outputs__aspp_branches_2_branches_2_0_Conv[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_aspp_branches_2_branches_2_0_Conv_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__aspp_branches_2_branches_2_0_Conv_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__aspp_branches_2_branches_2_2_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _aspp_branches_2_branches_2_2_Relu */
  Qnn_Param_t params__aspp_branches_2_branches_2_2_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__aspp_branches_2_branches_2_2_Relu[] = {
    "_aspp_branches_2_branches_2_0_Conv_output_0"
  };
  uint32_t dimensions__aspp_branches_2_branches_2_2_Relu_output_0[] = {1, 32, 32, 96};
  Qnn_Tensor_t outputs__aspp_branches_2_branches_2_2_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_aspp_branches_2_branches_2_2_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__aspp_branches_2_branches_2_2_Relu, // Node Params
                         1, // Num Node Params
                         inputs__aspp_branches_2_branches_2_2_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__aspp_branches_2_branches_2_2_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__aspp_branches_3_branches_3_0_Conv(QnnModel& model){
  ...
  uint32_t dimensions__aspp_branches_3_branches_3_0_Conv_output_0[] = {1, 32, 32, 96};
  Qnn_Tensor_t outputs__aspp_branches_3_branches_3_0_Conv[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_aspp_branches_3_branches_3_0_Conv_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__aspp_branches_3_branches_3_0_Conv_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__aspp_branches_3_branches_3_2_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _aspp_branches_3_branches_3_2_Relu */
  Qnn_Param_t params__aspp_branches_3_branches_3_2_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__aspp_branches_3_branches_3_2_Relu[] = {
    "_aspp_branches_3_branches_3_0_Conv_output_0"
  };
  uint32_t dimensions__aspp_branches_3_branches_3_2_Relu_output_0[] = {1, 32, 32, 96};
  Qnn_Tensor_t outputs__aspp_branches_3_branches_3_2_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_aspp_branches_3_branches_3_2_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__aspp_branches_3_branches_3_2_Relu, // Node Params
                         1, // Num Node Params
                         inputs__aspp_branches_3_branches_3_2_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__aspp_branches_3_branches_3_2_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__aspp_proj_proj_0_Conv(QnnModel& model){
  ...
  uint32_t dimensions__aspp_proj_proj_0_Conv_output_0[] = {1, 32, 32, 384};
  Qnn_Tensor_t outputs__aspp_proj_proj_0_Conv[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_aspp_proj_proj_0_Conv_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__aspp_proj_proj_0_Conv_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__aspp_proj_proj_2_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _aspp_proj_proj_2_Relu */
  Qnn_Param_t params__aspp_proj_proj_2_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__aspp_proj_proj_2_Relu[] = {
    "_aspp_proj_proj_0_Conv_output_0"
  };
  uint32_t dimensions__aspp_proj_proj_2_Relu_output_0[] = {1, 32, 32, 384};
  Qnn_Tensor_t outputs__aspp_proj_proj_2_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_aspp_proj_proj_2_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__aspp_proj_proj_2_Relu, // Node Params
                         1, // Num Node Params
                         inputs__aspp_proj_proj_2_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__aspp_proj_proj_2_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec3_c1__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec3_c1__prepad_Pad */
  uint32_t dimensions___dec3_c1__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __dec3_c1__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__dec3_c1__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__dec3_c1__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___dec3_c1__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__dec3_c1__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__dec3_c1__prepad_Pad[] = {
    "_Concat_2_output_0"
  };
  uint32_t dimensions__dec3_c1__prepad_Pad_output_0[] = {1, 66, 66, 576};
  Qnn_Tensor_t outputs__dec3_c1__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec3_c1__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec3_c1__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec3_c1__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__dec3_c1__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__dec3_c1__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec3_c1__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec3_c1_depth_Conv(QnnModel& model){
  ...
  uint32_t __dec3_c1_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__dec3_c1_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__dec3_c1_norm_Add_output_0[] = {1, 64, 64, 192};
  Qnn_Tensor_t outputs__dec3_c1_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec3_c1_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec3_c1_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__dec3_c1_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec3_c1_act_Relu */
  Qnn_Param_t params__dec3_c1_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__dec3_c1_act_Relu[] = {
    "_dec3_c1_norm_Add_output_0"
  };
  uint32_t dimensions__dec3_c1_act_Relu_output_0[] = {1, 64, 64, 192};
  Qnn_Tensor_t outputs__dec3_c1_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec3_c1_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__dec3_c1_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__dec3_c1_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec3_c1_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__dec3_c2__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec3_c2__prepad_Pad */
  uint32_t dimensions___dec3_c2__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __dec3_c2__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__dec3_c2__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__dec3_c2__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___dec3_c2__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__dec3_c2__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__dec3_c2__prepad_Pad[] = {
    "_dec3_c1_act_Relu_output_0"
  };
  uint32_t dimensions__dec3_c2__prepad_Pad_output_0[] = {1, 66, 66, 192};
  Qnn_Tensor_t outputs__dec3_c2__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec3_c2__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec3_c2__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec3_c2__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__dec3_c2__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__dec3_c2__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec3_c2__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec3_c2_depth_Conv(QnnModel& model){
  ...
  uint32_t __dec3_c2_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__dec3_c2_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__dec3_c2_norm_Add_output_0[] = {1, 64, 64, 192};
  Qnn_Tensor_t outputs__dec3_c2_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec3_c2_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec3_c2_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__dec3_c2_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec3_c2_act_Relu */
  Qnn_Param_t params__dec3_c2_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__dec3_c2_act_Relu[] = {
    "_dec3_c2_norm_Add_output_0"
  };
  uint32_t dimensions__dec3_c2_act_Relu_output_0[] = {1, 64, 64, 192};
  Qnn_Tensor_t outputs__dec3_c2_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec3_c2_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__dec3_c2_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__dec3_c2_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec3_c2_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec2_c1__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec2_c1__prepad_Pad */
  uint32_t dimensions___dec2_c1__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __dec2_c1__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__dec2_c1__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__dec2_c1__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___dec2_c1__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__dec2_c1__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__dec2_c1__prepad_Pad[] = {
    "_Concat_5_output_0"
  };
  uint32_t dimensions__dec2_c1__prepad_Pad_output_0[] = {1, 130, 130, 288};
  Qnn_Tensor_t outputs__dec2_c1__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec2_c1__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec2_c1__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec2_c1__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__dec2_c1__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__dec2_c1__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec2_c1__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec2_c1_depth_Conv(QnnModel& model){
  ...
  uint32_t __dec2_c1_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__dec2_c1_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__dec2_c1_norm_Add_output_0[] = {1, 128, 128, 96};
  Qnn_Tensor_t outputs__dec2_c1_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec2_c1_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec2_c1_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__dec2_c1_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec2_c1_act_Relu */
  Qnn_Param_t params__dec2_c1_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__dec2_c1_act_Relu[] = {
    "_dec2_c1_norm_Add_output_0"
  };
  uint32_t dimensions__dec2_c1_act_Relu_output_0[] = {1, 128, 128, 96};
  Qnn_Tensor_t outputs__dec2_c1_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec2_c1_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__dec2_c1_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__dec2_c1_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec2_c1_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__dec2_c2__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec2_c2__prepad_Pad */
  uint32_t dimensions___dec2_c2__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __dec2_c2__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__dec2_c2__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__dec2_c2__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___dec2_c2__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__dec2_c2__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__dec2_c2__prepad_Pad[] = {
    "_dec2_c1_act_Relu_output_0"
  };
  uint32_t dimensions__dec2_c2__prepad_Pad_output_0[] = {1, 130, 130, 96};
  Qnn_Tensor_t outputs__dec2_c2__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec2_c2__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec2_c2__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec2_c2__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__dec2_c2__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__dec2_c2__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec2_c2__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec2_c2_depth_Conv(QnnModel& model){
  ...
  uint32_t __dec2_c2_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__dec2_c2_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__dec2_c2_norm_Add_output_0[] = {1, 128, 128, 96};
  Qnn_Tensor_t outputs__dec2_c2_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec2_c2_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec2_c2_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__dec2_c2_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec2_c2_act_Relu */
  Qnn_Param_t params__dec2_c2_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__dec2_c2_act_Relu[] = {
    "_dec2_c2_norm_Add_output_0"
  };
  uint32_t dimensions__dec2_c2_act_Relu_output_0[] = {1, 128, 128, 96};
  Qnn_Tensor_t outputs__dec2_c2_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec2_c2_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__dec2_c2_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__dec2_c2_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec2_c2_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec1_c1__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec1_c1__prepad_Pad */
  uint32_t dimensions___dec1_c1__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __dec1_c1__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__dec1_c1__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__dec1_c1__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___dec1_c1__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__dec1_c1__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__dec1_c1__prepad_Pad[] = {
    "_Concat_8_output_0"
  };
  uint32_t dimensions__dec1_c1__prepad_Pad_output_0[] = {1, 258, 258, 144};
  Qnn_Tensor_t outputs__dec1_c1__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec1_c1__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec1_c1__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec1_c1__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__dec1_c1__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__dec1_c1__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec1_c1__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec1_c1_depth_Conv(QnnModel& model){
  ...
  uint32_t __dec1_c1_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__dec1_c1_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__dec1_c1_norm_Add_output_0[] = {1, 256, 256, 48};
  Qnn_Tensor_t outputs__dec1_c1_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec1_c1_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec1_c1_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__dec1_c1_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec1_c1_act_Relu */
  Qnn_Param_t params__dec1_c1_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__dec1_c1_act_Relu[] = {
    "_dec1_c1_norm_Add_output_0"
  };
  uint32_t dimensions__dec1_c1_act_Relu_output_0[] = {1, 256, 256, 48};
  Qnn_Tensor_t outputs__dec1_c1_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec1_c1_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__dec1_c1_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__dec1_c1_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec1_c1_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__dec1_c2__prepad_Pad(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec1_c2__prepad_Pad */
  uint32_t dimensions___dec1_c2__prepad_Pad_pad_amount[] = {4, 2};
  uint32_t __dec1_c2__prepad_Pad_pad_amount[] = {0, 0, 1, 1, 1, 1, 0, 0};
  Qnn_Param_t params__dec1_c2__prepad_Pad[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="pad_amount",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "__dec1_c2__prepad_Pad_pad_amount",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions___dec1_c2__prepad_Pad_pad_amount,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)__dec1_c2__prepad_Pad_pad_amount,
                           .dataSize=32}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__dec1_c2__prepad_Pad[] = {
    "_dec1_c1_act_Relu_output_0"
  };
  uint32_t dimensions__dec1_c2__prepad_Pad_output_0[] = {1, 258, 258, 48};
  Qnn_Tensor_t outputs__dec1_c2__prepad_Pad[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec1_c2__prepad_Pad_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec1_c2__prepad_Pad_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec1_c2__prepad_Pad", // Node Name
                         "qti.aisw", // Package Name
                         "Pad", // Qnn Node Type
                         params__dec1_c2__prepad_Pad, // Node Params
                         2, // Num Node Params
                         inputs__dec1_c2__prepad_Pad, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec1_c2__prepad_Pad, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__dec1_c2_depth_Conv(QnnModel& model){
  ...
  uint32_t __dec1_c2_depth_Conv_pad_amount[] = {0, 0, 0, 0};
...
static ModelError_t addNode__dec1_c2_norm_Reshape_GroupNorm(QnnModel& model){
  ...
  uint32_t dimensions__dec1_c2_norm_Add_output_0[] = {1, 256, 256, 48};
  Qnn_Tensor_t outputs__dec1_c2_norm_Reshape_GroupNorm[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_dec1_c2_norm_Add_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__dec1_c2_norm_Add_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__dec1_c2_act_Relu(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _dec1_c2_act_Relu */
  Qnn_Param_t params__dec1_c2_act_Relu[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 4}}}}
  };
  const char*  inputs__dec1_c2_act_Relu[] = {
    "_dec1_c2_norm_Add_output_0"
  };
  uint32_t dimensions__dec1_c2_act_Relu_output_0[] = {1, 256, 256, 48};
  Qnn_Tensor_t outputs__dec1_c2_act_Relu[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_dec1_c2_act_Relu", // Node Name
                         "qti.aisw", // Package Name
                         "ElementWiseNeuron", // Qnn Node Type
                         params__dec1_c2_act_Relu, // Node Params
                         1, // Num Node Params
                         inputs__dec1_c2_act_Relu, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__dec1_c2_act_Relu, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for radio_map_liteunet_qnn*/
  QnnModel radio_map_liteunet_qnn;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("radio_map_liteunet_qnn", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(radio_map_liteunet_qnn.initialize(backendHandle, interface, contextHandle, "radio_map_liteunet_qnn", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_input(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c1__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc1_c1_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc1_c1_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c1_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc1_c1_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc1_c1_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c1_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_728(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_729(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c1_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c1_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c2__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc1_c2_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc1_c2_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c2_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc1_c2_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc1_c2_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c2_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_735(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_736(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c2_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc1_c2_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__pool_AveragePool(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c1__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc2_c1_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc2_c1_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c1_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc2_c1_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc2_c1_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c1_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_742(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_743(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c1_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c1_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c2__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc2_c2_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc2_c2_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c2_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc2_c2_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc2_c2_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c2_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_749(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_750(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c2_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc2_c2_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__pool_1_AveragePool(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c1__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc3_c1_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc3_c1_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c1_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc3_c1_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc3_c1_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c1_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_756(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_757(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c1_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c1_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c2__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc3_c2_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc3_c2_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c2_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_enc3_c2_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__enc3_c2_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c2_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_763(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_764(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c2_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__enc3_c2_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__pool_2_AveragePool(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c1__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_bottleneck_c1_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__bottleneck_c1_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c1_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_bottleneck_c1_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__bottleneck_c1_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c1_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_770(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_771(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c1_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c1_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c2__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_bottleneck_c2_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__bottleneck_c2_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c2_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_bottleneck_c2_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__bottleneck_c2_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c2_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_777(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_778(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c2_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__bottleneck_c2_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_709(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_710(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_branches_0_branches_0_0_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_branches_0_branches_0_2_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_712(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_713(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_branches_1_branches_1_0_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_branches_1_branches_1_2_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_715(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_716(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_branches_2_branches_2_0_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_branches_2_branches_2_2_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_718(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_719(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_branches_3_branches_3_0_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_branches_3_branches_3_2_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_Concat(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_721(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Conv_722(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_proj_proj_0_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__aspp_proj_proj_2_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__Resize(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__Concat_2(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c1__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec3_c1_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec3_c1_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c1_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec3_c1_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec3_c1_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c1_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_784(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_785(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c1_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c1_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c2__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec3_c2_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec3_c2_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c2_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec3_c2_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec3_c2_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c2_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_791(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_792(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c2_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec3_c2_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__Resize_1(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__Concat_5(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c1__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec2_c1_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec2_c1_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c1_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec2_c1_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec2_c1_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c1_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_798(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_799(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c1_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c1_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c2__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec2_c2_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec2_c2_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c2_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec2_c2_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec2_c2_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c2_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_805(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_806(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c2_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec2_c2_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__Resize_2(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__Concat_8(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c1__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec1_c1_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec1_c1_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c1_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec1_c1_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec1_c1_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c1_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_812(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_813(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c1_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c1_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c2__prepad_Pad(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec1_c2_depth_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec1_c2_depth_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c2_depth_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_dec1_c2_point_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor__dec1_c2_point_Conv_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c2_point_Conv(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Mul_819(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_onnx__Add_820(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c2_norm_Reshape_GroupNorm(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__dec1_c2_act_Relu(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_head_weight(radio_map_liteunet_qnn), err);
  VALIDATE(addTensor_head_bias(radio_map_liteunet_qnn), err);
  VALIDATE(addNode__head_Conv(radio_map_liteunet_qnn), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&radio_map_liteunet_qnn};

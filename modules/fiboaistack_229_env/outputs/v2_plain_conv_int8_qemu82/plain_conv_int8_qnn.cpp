...
static ModelError_t addTensor_input(QnnModel& model){
  ...
  uint32_t dimensions_input[] = {1, 8, 8, 3};
                           ...
                           (Qnn_Tensor_t) {
                               ...
                               {.v2= {
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_DEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0167774055153131f, .offset= -77}}},
                                 .rank= 4,
...
static ModelError_t addTensor_conv_weight(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_conv_weight[] = {3, 3, 3, 5};
  VALIDATE(model.addTensor("conv_weight", // Tensor Name
                           (Qnn_Tensor_t) {
                               ...
                               {.v2= {
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_DEFINED,
                                                    QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                                                    {.scaleOffsetEncoding= {.scale= 0.0001225490268553f, .offset= 0}}},
                                 .rank= 4,
...
static ModelError_t addTensor_conv_bias(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_conv_bias[] = {5};
...
static ModelError_t addNode__conv_Conv(QnnModel& model){
  ...
  uint32_t dimensions_output[] = {1, 8, 8, 5};
  Qnn_Tensor_t outputs__conv_Conv[] = {
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_DEFINED,
                               QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                               {.scaleOffsetEncoding= {.scale= 0.0091625759378076f, .offset= -7}}},
            .rank= 4,
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for plain_conv_int8_qnn*/
  QnnModel plain_conv_int8_qnn;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("plain_conv_int8_qnn", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(plain_conv_int8_qnn.initialize(backendHandle, interface, contextHandle, "plain_conv_int8_qnn", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_input(plain_conv_int8_qnn), err);
  VALIDATE(addTensor_conv_weight(plain_conv_int8_qnn), err);
  VALIDATE(addTensor_conv_bias(plain_conv_int8_qnn), err);
  VALIDATE(addNode__conv_Conv(plain_conv_int8_qnn), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&plain_conv_int8_qnn};

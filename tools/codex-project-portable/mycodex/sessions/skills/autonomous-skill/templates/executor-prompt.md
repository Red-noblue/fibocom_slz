...
## STEP 8: RECORD GIT STATUS

Do not create commits unless the user task explicitly requires committing.
For unattended night work, record the git state instead:
...
2. **Record git status** - Leave a concise note in `{TASK_DIR}/progress.md`
